...
<head>
  <meta charset="utf-8" />
  <title>Esprima: Identifier Highlight</title>
...
<body>
  ...
  <div class="row">
    <div class="twelve columns">
       <h3 class="subheader"><strong>Identifier Highlight</strong> to spot everything</h3>
    </div>
  </div>
...
_.shuffle = function(obj) {
    ...
    <div class="four columns">
      <div class="panel">
          <p>When the cursor is placed on a variable or a function,
          all other <strong>identical references</strong> will be highlighted.</p>
      </div>
    </div>
  </div>
